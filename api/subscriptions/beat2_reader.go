...
import (
	...
	"github.com/miniBamboo/luckyshare/luckyshare/bloom"
)
...
func newBeat2Reader(repo *chain.Repository, position luckyshare.Bytes32) *beat2Reader {
	return &beat2Reader{
		repo:        repo,
...
func (br *beat2Reader) Read() ([]interface{}, bool, error) {
	...
	bloomAdd := func(key []byte) {
		...
		if len(key) <= luckyshare.AddressLength {
