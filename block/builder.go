...
func (b *Builder) ParentID(id luckyshare.Bytes32) *Builder {
...
func (b *Builder) Beneficiary(addr luckyshare.Address) *Builder {
	b.headerBody.Beneficiary = addr
	return b
}

// StateRoot set state root.
func (b *Builder) StateRoot(hash luckyshare.Bytes32) *Builder {
	b.headerBody.StateRoot = hash
	return b
}

// ReceiptsRoot set receipts root.
func (b *Builder) ReceiptsRoot(hash luckyshare.Bytes32) *Builder {
