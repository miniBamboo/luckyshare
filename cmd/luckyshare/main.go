...
import (
	...
	"github.com/miniBamboo/luckyshare/api"
	"github.com/miniBamboo/luckyshare/cmd/luckyshare/node"
	"github.com/miniBamboo/luckyshare/cmd/luckyshare/pruner"
	"github.com/miniBamboo/luckyshare/cmd/luckyshare/solo"
...
func masterKeyAction(ctx *cli.Context) error {
	...
	if !hasImportFlag && !hasExportFlag {
		...
		fmt.Println("Master:", luckyshare.Address(crypto.PubkeyToAddress(masterKey.PublicKey)))
		return nil
	}
	...
	if hasImportFlag {
		...
		fmt.Println("Master key imported:", luckyshare.Address(key.Address))
		return nil
	}
