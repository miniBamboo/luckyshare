...
func (n *Node) writeLogs(diff []luckyshare.Bytes32, newBlock *block.Block, newReceipts tx.Receipts) error {
...
func checkClockOffset() {
	...
	if resp.ClockOffset > time.Duration(luckyshare.BlockInterval)*time.Second/2 {
