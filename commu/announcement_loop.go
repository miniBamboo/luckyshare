...
import (
	...
	"github.com/miniBamboo/luckyshare/commu/proto"
	"github.com/miniBamboo/luckyshare/luckyshare"
)

type announcement struct {
	newBlockID luckyshare.Bytes32
	peer       *Peer
}
...
func (c *Communicator) announcementLoop() {
	...
	fetchingBlockIDs := map[luckyshare.Bytes32]int{}
...
func (c *Communicator) fetchBlockByID(peer *Peer, newBlockID luckyshare.Bytes32) {
