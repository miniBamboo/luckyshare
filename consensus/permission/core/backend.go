...
import (
	...
	eb "github.com/miniBamboo/luckyshare/consensus/permission/v0/bind"
)
...
func getBackend(contractBackend ptype.ContractBackend) (*PermissionModelV0, error) {
	backend := PermissionModelV0{ContractBackend: contractBackend}
...
func getBackendWithTransactOpts(contractBackend ptype.ContractBackend, transactOpts *bind.TransactOpts) (*PermissionModelV0, error) {
