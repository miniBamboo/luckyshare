	...
	builder := new(Builder).
		...
		State(func(state *state.State) error {
			...
			for _, anode := range initialAuthorityNodes {
				tokenSupply.Add(tokenSupply, luckyshare.InitialProposerEndorsement)
				if err := state.SetBalance(anode.endorsorAddress, luckyshare.InitialProposerEndorsement); err != nil {
					return err
				}
			...
			if err := state.SetBalance(luckyshare.MustParseAddress("0x137053dfbe6c0a43f915ad2efefefdcc2708e975"), amount); err != nil {
				return err
			}
			if err := state.SetEnergy(luckyshare.MustParseAddress("0x137053dfbe6c0a43f915ad2efefefdcc2708e975"), &big.Int{}, launchTime); err != nil {
				return err
			}

			tokenSupply.Add(tokenSupply, amount)
			if err := state.SetBalance(luckyshare.MustParseAddress("0xaf111431c1284a5e16d2eecd2daed133ce96820e"), amount); err != nil {
				return err
			}
			if err := state.SetEnergy(luckyshare.MustParseAddress("0xaf111431c1284a5e16d2eecd2daed133ce96820e"), &big.Int{}, launchTime); err != nil {
				return err
			}

			tokenSupply.Add(tokenSupply, amount)
			if err := state.SetBalance(luckyshare.MustParseAddress("0x997522a4274336f4b86af4a6ed9e45aedcc6d360"), amount); err != nil {
				return err
			}
			if err := state.SetEnergy(luckyshare.MustParseAddress("0x997522a4274336f4b86af4a6ed9e45aedcc6d360"), &big.Int{}, launchTime); err != nil {
				return err
			}

			tokenSupply.Add(tokenSupply, amount)
			if err := state.SetBalance(luckyshare.MustParseAddress("0x0bd7b06debd1522e75e4b91ff598f107fd826c8a"), amount); err != nil {
				return err
			}
			if err := state.SetEnergy(luckyshare.MustParseAddress("0x0bd7b06debd1522e75e4b91ff598f107fd826c8a"), &big.Int{}, launchTime); err != nil {
				return err
			}
...
type authorityNode struct {
	masterAddress   luckyshare.Address
	endorsorAddress luckyshare.Address
	identity        luckyshare.Bytes32
}
...
func loadApprovers() []*approver {
	return []*approver{
		{luckyshare.MustParseAddress("0xb0f6d9933c1c2f4d891ca479343921f2d32e0fad"), "CY Cheung"},
		{luckyshare.MustParseAddress("0xda48cc4d23b41158e1294e0e4bcce8e9953cee26"), "George Kang"},
		{luckyshare.MustParseAddress("0xca7b45abe0d421e5628d2224bfe8fa6a6cf7c51b"), "Jay Zhang"},
		{luckyshare.MustParseAddress("0xa03f185f2a0def1efdd687ef3b96e404869d93de"), "Margaret Rui Zhu"},
		{luckyshare.MustParseAddress("0x74bac19f78369637db63f7496ecb5f88cc183672"), "Peter Zhou"},
		{luckyshare.MustParseAddress("0x5fefc7836af047c949d1fea72839823d2f06f7e3"), "Renato Grottola"},
		{luckyshare.MustParseAddress("0x7519874d0f7d31b5f0fd6f0429a4e5ece6f3fd49"), "Sunny Lu"},
	}
}
...
func loadAuthorityNodes() []*authorityNode {
	...
	for _, item := range all {
		candidates = append(candidates, &authorityNode{
			masterAddress:   luckyshare.MustParseAddress(item[0]),
			endorsorAddress: luckyshare.MustParseAddress(item[1]),
			identity:        luckyshare.MustParseBytes32(item[2]),
		})
	}
	return candidates
}
