...
type Trie struct {
	...
	secureKeys   map[luckyshare.Bytes32][]byte
	permanent    bool
}
...
func (t *Trie) commit(permanent bool) (root luckyshare.Bytes32, err error) {
	obj, err := t.lazyInit()
	if err != nil {
		return
	}
...
func (t *Trie) hashKey(key []byte, save bool) []byte {
	...
	h := luckyshare.Blake2b(key)
	if save {
		if t.secureKeys == nil {
			t.secureKeys = make(map[luckyshare.Bytes32][]byte)
		}
...
func (t *Trie) doCommit(putter kv.Putter, trieObj *trie.Trie, space byte) (root luckyshare.Bytes32, err error) {
...
func (i *errorIterator) Hash() luckyshare.Bytes32   { return luckyshare.Bytes32{} }
func (i *errorIterator) Node() ([]byte, error)      { return nil, i.err }
func (i *errorIterator) Parent() luckyshare.Bytes32 { return luckyshare.Bytes32{} }
