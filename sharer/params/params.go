...
func New(addr luckyshare.Address, state *state.State) *Params {
	return &Params{addr, state}
}

// Get native way to get param.
func (p *Params) Get(key luckyshare.Bytes32) (value *big.Int, err error) {
...
func (p *Params) Set(key luckyshare.Bytes32, value *big.Int) error {
