...
func NewSecure(root luckyshare.Bytes32, db Database) (*SecureTrie, error) {
	if db == nil {
...
// from the database.
func (t *SecureTrie) Commit() (root luckyshare.Bytes32, err error) {
	return t.CommitTo(t.trie.db)
}

func (t *SecureTrie) Hash() luckyshare.Bytes32 {
	return t.trie.Hash()
}
...
func (t *SecureTrie) CommitTo(db DatabaseWriter) (root luckyshare.Bytes32, err error) {
